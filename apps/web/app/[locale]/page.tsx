...
export default async function HomePage({ params }: Props) {
  ...
  const cmsPage = await getCorePageContent("home", typedLocale)
  ...
  const latestPosts = (await getAllBlogPostsWithCms(typedLocale)).slice(0, 3)
      ...
      <section className="relative flex min-h-[calc(100svh-73px)] items-center overflow-hidden bg-[#faf9f7]">
        ...
        <div className="container mx-auto px-4 py-20 lg:py-32 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif mb-6 text-balance">
            {cmsPage?.title ?? dict.home.heroTitle}
          </h1>
          <p className="max-w-xl mx-auto text-muted-foreground mb-8">
            {cmsPage?.heroDescription ?? dict.home.heroDescription}
          </p>
          <BookingButton className="px-8" locale={typedLocale} />
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <Link
                href={localizedRoute("/about", typedLocale)}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service) => (
              <Link
                key={service.title}
                href={localizedRoute(service.href, typedLocale)}
