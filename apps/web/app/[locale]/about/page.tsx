...
export async function generateMetadata({
  ...
  const cmsPage = await getCorePageContent("about", typedLocale)
  const title = cmsPage?.metaTitle ?? cmsPage?.title ?? dict.about.aboutPitonne
  const description = cmsPage?.metaDescription ?? cmsPage?.heroDescription ?? dict.about.metaDescription

  return {
    title,
    description,
    alternates: localizedHreflangAlternates("/about/", typedLocale),
    openGraph: {
      title,
      description,
      url: localizedHreflangAlternates("/about/", typedLocale).canonical,
    },
  }
}
  ...
  return (
    <>
      <PageHero
        ...
        title={cmsPage?.title ?? dict.about.aboutPitonne}
        description={cmsPage?.heroDescription ?? dict.about.heroDescription}
      />
