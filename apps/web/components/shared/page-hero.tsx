    ...
    <section className={`bg-[#faf9f7] ${sectionPadding[size]} ${className}`}>
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-6xl">
          ...
          {eyebrow && <div className="mb-4 text-sm uppercase tracking-widest text-[#7A8F87]">{eyebrow}</div>}
          ...
          {description && <div className="max-w-4xl text-lg text-muted-foreground">{description}</div>}
