  ...
  return (
    <aside className="space-y-6 lg:sticky lg:top-24 lg:self-start">
      <div className="rounded-lg border border-border bg-card p-6">
        <h2 className="mb-4 text-lg font-semibold text-foreground">Book a Consultation</h2>
        <p className="mb-5 text-sm text-muted-foreground">
          Interested in learning more? Book a consultation to discuss how our services can support your wellness goals.
        </p>
